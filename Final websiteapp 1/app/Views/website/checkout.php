...
<main class="page-main checkout-page" data-site-checkout-page>
  <section class="page-hero compact-hero checkout-hero">
    ...
    <div class="checkout-hero-card" aria-label="Thông tin đặt hàng">
      <span>Website Order</span>
      <strong>3 bước rõ ràng</strong>
      <small>Giỏ hàng · Nhận hàng · Thanh toán</small>
    </div>
  </section>

  <section class="section-shell page-section checkout-workspace">
    <div class="checkout-stepper" aria-label="Quy trình đặt hàng">
      <span><strong>1</strong><em>Giỏ hàng</em><small>Kiểm tra món, size và ghi chú</small></span>
      <span><strong>2</strong><em>Nhận hàng</em><small>Chọn quầy hoặc giao tận nơi</small></span>
      <span><strong>3</strong><em>Thanh toán</em><small>Voucher, điểm và xác nhận</small></span>
    </div>
      ...
      <aside class="checkout-side">
        <section class="checkout-card">
          ...
          <div class="checkout-fields">
            ...
            <label class="field">Ghi chú đơn hàng (Tùy chọn)
