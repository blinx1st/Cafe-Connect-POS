...
final class RolePolicy
{
    ...
    private const ENDPOINT_ROLES = [
        ...
        '/api/refund-invoice' => ['cashier', 'manager', 'owner', 'admin'],
        '/api/refund-history' => ['cashier', 'manager', 'owner', 'admin'],
        ...
        '/api/material-save' => ['manager', 'owner', 'admin'],
        '/api/material-delete' => ['manager', 'owner', 'admin'],
        '/api/material-restore' => ['manager', 'owner', 'admin'],
        '/api/inventory-stock-save' => ['manager', 'owner', 'admin'],
        '/api/recipe-save' => ['manager', 'owner', 'admin'],
        '/api/recipe-delete' => ['manager', 'owner', 'admin'],
        '/api/recipe-restore' => ['manager', 'owner', 'admin'],
